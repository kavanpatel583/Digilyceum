angular.module('starter')
  .controller('UploadSupporterDocumentCtrl', function ($scope, $state, $ionicHistory, sharedUtils, SessionService, IonicPopupService, CommonService,
    ...
    $scope.submitUserDetails = function () {
      ...
      UserService.setSupporterCandidatedata($scope.cr_id, $scope.supporter_id, $scope.userdata).then(function (ref) {
        // $scope.AgeProofObj = "";
        // $scope.ResidenceProofObj = "";
        // $scope.FessReceiptObj = "";
        // $scope.HscMarkSheetObj = "";
